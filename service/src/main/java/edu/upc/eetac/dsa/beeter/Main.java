...
public class Main {
   ...
   // public static final String BASE_URI = "http://localhost:8080/myapp/"; // Se substituye línea por la siguiente para no hardcorear la URI y sea editable desde beeter.properties
    ...
    public static HttpServer startServer() {
       ...
       // final ResourceConfig rc = new ResourceConfig().packages("edu.upc.eetac.dsa.beeter"); Substituimos línea por la siguiente
